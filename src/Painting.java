...
public class Painting extends Artwork {
	 ...
	 * 
	 * @param seller
	 *            - the user who is selling the painting
	 * @param date
	 *            - date when put up for sale
	 * @param name
	 *            - title of the painting
	 * @param creatorName
	 *            - name of who created the painting
	 * @param yearWasMade
	 *            - year of paintings creation
	 * @param numberOfBids
	 *            - how many bids allowed
	 * @param reservePrice
	 *            - minimum price for bids on painting
	 * @param width
	 *            - width of the painting in cm
	 * @param height
	 *            - height of the painting in cm
	 */
	...
	/**
	 * Method to format how the painting information is written to a text file for
	 * easier reading
	 * 
